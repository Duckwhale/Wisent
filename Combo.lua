...
local SPELL_POWER_RUNES = Enum.PowerType.Runes -- This format was deprecated in 7.2.5, and removed in 8.0.1
local SPELL_POWER_PAIN = Enum.PowerType.Pain
local SPELL_POWER_COMBO_POINTS = Enum.PowerType.ComboPoins
