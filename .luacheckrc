-- luacheck configuration file (static analyzer), see
-- https://github.com/mpeterv/luacheck
-- https://luarocks.org/modules/luarocks/luacheck

-- which Lua interpreter to use
std = "lua51" -- 51 = 5.1 -> This is what the WOW client uses
...
ignore = {
	...
	"611", -- A line containing nothing but whitespaces
	"612", -- A line contains trailing whitespace.
	"614", -- Trailing whitespace in a comment.
}

-- Globals to assume are set (Disclaimer: I borrowed this list from the WeakAuras repository, so most of them aren't used by this addon...)
globals = {
	"_G",
	"bit",
