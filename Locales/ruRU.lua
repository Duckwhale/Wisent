local L = LibStub("AceLocale-3.0"):NewLocale("Wisent", "ruRU")
L = L or {}

--@localization(locale="ruRU", format="lua_additive_table", namespace="", same-key-is-true="true", handle-subnamespaces="none", handle-unlocalized="ignore")@
...
-- L["BlizzDesc"] = "Показать фрейм баффов Blizzard "
...
-- L["ColsName"] = "Колонки"
-- L["CooldownDesc"] = "Показать анимацию восстановления."
-- L["CooldownName"] = "Восстановление"
...
-- L["Profile"] = "Профиль"
-- L["ProfileAvailable"] = "Доступные профиля"
